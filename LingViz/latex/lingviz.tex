...
%Because of the sparse coverage of the WALS data, 
...
%In some cases, a few languages are almost certainly more closely related based on this. 
...
% In some cases, all three are brought together in a single image. 
