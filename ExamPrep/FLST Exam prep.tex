...
\subsection{Cognitive Foundations II}
 ...
 \item Reading times can investiage ambiguities. Methods: whole sentence, self-paced central, self-paced moving.
 \end{itemise}
...
\begin{itemize}
 \item An interpretation function $\llbracket\rrbracket ^{M,g}$
\end{itemize}
