"""
Richard Littauer
Code for scraping Rangi Facebook group.
March 30, 2012
...
output.write('<text id="Rangi_scrape" source_id="rangi_scrape" title="Rangi Facebook Scrape">')
output.write('<metadata idref="Rangi_scrape">\
